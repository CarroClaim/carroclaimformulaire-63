...
<svg width="418" height="558" viewBox="0 0 418 558" xmlns="http://www.w3.org/2000/svg" style="background: white;">
  ...
  <g>
    ...
    <!-- Ailes avant -->
    <path ${getPartStyle("Aile avant gauche")} d="m 109,195 h 16.5 c 0,0 7.5,0 7.5,-5 0,-5 0,-10 0,-10 L 110,161 c 0,0 -19,-9 -22,-15 -3,-6 -4.5,-13.5 -4.5,-13.5 0,0 -8.5,-1.5 -16.5,-5 -8,-3.5 -15,-12.5 -15,-12.5 0,0 -6.5,0 -19,0 -12.5,0 -24.25,1.75 -32.5,4 -8.25,2.25 -16.75,8.25 -16.75,8.25 0,0 2.25,6.25 4.75,14.25 2.5,8 4.25,16.25 4.25,16.25 0,0 10.25,6.75 20.25,10.75 10,4 18.5,7.25 18.5,7.25 0,0 13.25,0.5 24.25,1 11,0.5 21.5,0.5 21.5,0.5 z" />
    <path ${getPartStyle("Aile avant droite")} d="m 310,195 h -16.5 c 0,0 -7.5,0 -7.5,-5 0,-5 0,-10 0,-10 L 309,161 c 0,0 19,-9 22,-15 3,-6 4.5,-13.5 4.5,-13.5 0,0 8.5,-1.5 16.5,-5 8,-3.5 15,-12.5 15,-12.5 0,0 6.5,0 19,0 12.5,0 24.25,1.75 32.5,4 8.25,2.25 16.75,8.25 16.75,8.25 0,0 -2.25,6.25 -4.75,14.25 -2.5,8 -4.25,16.25 -4.25,16.25 0,0 -10.25,6.75 -20.25,10.75 -10,4 -18.5,7.25 -18.5,7.25 0,0 -13.25,0.5 -24.25,1 -11,0.5 -21.5,0.5 -21.5,0.5 z" />
    
    <!-- Ailes arrière -->
    <path ${getPartStyle("Aile arrière gauche")} d="m 109,312.5 h 16.5 c 0,0 7.5,0 7.5,5 0,5 0,10 0,10 L 110,346.5 c 0,0 -19,9 -22,15 -3,6 -4.5,13.5 -4.5,13.5 0,0 -8.5,1.5 -16.5,5 -8,3.5 -15,12.5 -15,12.5 0,0 -6.5,0 -19,0 -12.5,0 -24.25,-1.75 -32.5,-4 -8.25,-2.25 -16.75,-8.25 -16.75,-8.25 0,0 2.25,-6.25 4.75,-14.25 2.5,-8 4.25,-16.25 4.25,-16.25 0,0 10.25,-6.75 20.25,-10.75 10,-4 18.5,-7.25 18.5,-7.25 0,0 13.25,-0.5 24.25,-1 11,-0.5 21.5,-0.5 21.5,-0.5 z" />
    <path ${getPartStyle("Aile arrière droite")} d="m 310,312.5 h -16.5 c 0,0 -7.5,0 -7.5,5 0,5 0,10 0,10 L 309,346.5 c 0,0 19,9 22,15 3,6 4.5,13.5 4.5,13.5 0,0 8.5,1.5 16.5,5 8,3.5 15,12.5 15,12.5 0,0 6.5,0 19,0 12.5,0 24.25,-1.75 32.5,-4 8.25,-2.25 16.75,-8.25 16.75,-8.25 0,0 -2.25,-6.25 -4.75,-14.25 -2.5,-8 -4.25,-16.25 -4.25,-16.25 0,0 -10.25,-6.75 -20.25,-10.75 -10,-4 -18.5,-7.25 -18.5,-7.25 0,0 -13.25,-0.5 -24.25,-1 -11,-0.5 -21.5,-0.5 -21.5,-0.5 z" />
    
    <!-- Custodes -->
    <path ${getPartStyle("Custode gauche")} d="m 37,195 c 0,0 -7,0 -12.5,3 -5.5,3 -10.5,8 -10.5,8 v 30 c 0,0 5,5 10.5,8 5.5,3 12.5,3 12.5,3 v -52 z" />
    <path ${getPartStyle("Custode droite")} d="m 382,195.5 c 0,0 7,0 12.5,3 5.5,3 10.5,8 10.5,8 v 30 c 0,0 -5,5 -10.5,8 -5.5,3 -12.5,3 -12.5,3 v -52 z" />
    
    <!-- Montants -->
    <path ${getPartStyle("Montant A gauche")} d="m 133,180 c 0,0 -3,3 -3,8 0,5 3,8 3,8 l 8,-3 c 0,0 2,-5 0,-10 -2,-5 -8,-3 -8,-3 z" />
    <path ${getPartStyle("Montant A droite")} d="m 286,180 c 0,0 3,3 3,8 0,5 -3,8 -3,8 l -8,-3 c 0,0 -2,-5 0,-10 2,-5 8,-3 8,-3 z" />
    <path ${getPartStyle("Montant B gauche")} d="m 108,214 c 0,0 -3,3 -3,8 0,5 3,8 3,8 l 8,-3 c 0,0 2,-5 0,-10 -2,-5 -8,-3 -8,-3 z" />
    <path ${getPartStyle("Montant B droite")} d="m 311,214 c 0,0 3,3 3,8 0,5 -3,8 -3,8 l -8,-3 c 0,0 -2,-5 0,-10 2,-5 8,-3 8,-3 z" />
    <path ${getPartStyle("Montant C gauche")} d="m 108,317 c 0,0 -3,3 -3,8 0,5 3,8 3,8 l 8,-3 c 0,0 2,-5 0,-10 -2,-5 -8,-3 -8,-3 z" />
    <path ${getPartStyle("Montant C droite")} d="m 311,317 c 0,0 3,3 3,8 0,5 -3,8 -3,8 l -8,-3 c 0,0 -2,-5 0,-10 2,-5 8,-3 8,-3 z" />
    
    <!-- Carrosserie principale -->
    <path ${getPartStyle("Capot")} d="m 130,61 c 0,0 22.5,-13.5 55,-17 32.5,-3.5 68,-3.5 100.5,0 32.5,3.5 55,17 55,17 l -10,60 -95,-5 -95,5 z" />
    <path ${getPartStyle("Toit")} d="m 130,184 159,0 0,120 -159,0 z" />
    <path ${getPartStyle("Hayon")} d="m 130,430 c 0,0 22.5,13.5 55,17 32.5,3.5 68,3.5 100.5,0 32.5,-3.5 55,-17 55,-17 l -10,-60 -95,5 -95,-5 z" />
    
    <!-- Vitre de toit (optionnelle) -->
    <ellipse ${getPartStyle("Vitre de toit")} cx="209" cy="244" rx="40" ry="20" />
  </g>
</svg>`;
  }
