...
export const MultiStepForm: React.FC = () => {
  ...
  const steps: Step[] = [
    ...
    { id: 'type', title: 'Type de demande', icon: Settings },
    { id: 'damages', title: 'Dommages', icon: Car },
    { id: 'photos-docs', title: 'Documents', icon: Image },
    { id: 'photos-vehicle', title: 'Photos véhicule', icon: Camera },
  ...
  const canProceed = () => {
    switch (currentStep) {
      ...
      case 5: // Contact
        return formData.contact.firstName && formData.contact.lastName && 
      ...
      case 1: // Type de demande
        return (
          <div className="space-y-8">
            ...
            {formData.requestType === 'appointment' && (
              <div className="grid md:grid-cols-2 gap-6 bg-card p-6 rounded-xl border border-border">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
      ...
      case 2: // Sélection des dommages
        return (
          <div className="space-y-8">
            <div className="text-center">
              <div className="relative inline-block">
                <Car className="w-20 h-20 text-primary mx-auto mb-6" />
              </div>
              <h2 className="text-3xl font-bold text-foreground mb-4">Dommages du véhicule</h2>
              <p className="text-lg text-muted-foreground">Cliquez sur les zones endommagées :</p>
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 resize-none"
      ...
      case 4: // Photos véhicule
        return (
          <div className="space-y-8">
            ...
            <div className="space-y-8">
              <PhotoUpload
                label="4 angles du véhicule"
                description="1 photo de chaque angle : avant, arrière, gauche, droite"
                photos={formData.photos.vehicleAngles}
                onPhotosChange={(photos) => updatePhotos('vehicleAngles', photos)}
                maxFiles={4}
                showGuide={true}
              />
              ...
              <PhotoUpload
                ...
                photos={formData.photos.damagePhotos}
                onPhotosChange={(photos) => updatePhotos('damagePhotos', photos)}
                maxFiles={10}
              />
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="bg-gradient-card p-6 rounded-2xl shadow-card border border-border/50">
                ...
                {formData.requestType === 'appointment' && formData.preferredDate && (
              ...
              <div className="bg-gradient-card p-6 rounded-2xl shadow-card border border-border/50">
                ...
                <p className="text-muted-foreground">
                  {formData.selectedDamages.length > 0 
                    ? `${formData.selectedDamages.length} zone(s) sélectionnée(s)`
                    : 'Aucune zone spécifique sélectionnée'
                  }
                </p>
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-card/80 backdrop-blur-sm rounded-3xl shadow-elegant border border-border/50 overflow-hidden">
          ...
          <div className="bg-gradient-hero p-8 text-center">
            <h1 className="text-4xl font-bold text-white mb-2">Demande d'expertise automobile</h1>
            <p className="text-white/90">Transmettez vos photos pour obtenir un devis ou prendre rendez-vous</p>
          </div>
