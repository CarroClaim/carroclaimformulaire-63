  ...
  const renderStepContent = () => {
    switch (currentStep) {
      ...
      case 1:
        ...
        return (
          <div className="space-y-4 sm:space-y-8">
            ...
            {formData.requestType === 'appointment' && (
              <div className="grid md:grid-cols-2 gap-4 sm:gap-6 bg-card p-4 sm:p-6 rounded-xl border border-border">
                <div>
      ...
      case 3:
        // Photos véhicule
        return (
          <div className="space-y-4 sm:space-y-8 my-0 py-[2px] mx-[70px] px-[30px]">
            <div className="text-center">
              <div className="relative inline-block">
            ...
            <div className="space-y-4 sm:space-y-8">
              <PhotoUpload
                ...
                description="1 photo de chaque angle : avant-gauche, arrière-gauche, arrière-droite, avant-droite"
      ...
      case 5:
        ...
        return (
          <div className="space-y-4 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-8">
              <PhotoUpload
                label="Photos des dommages rapprochées"
                description="Photos détaillées et rapprochées de chaque zone endommagée"
              ...
              <div className="bg-gradient-card p-4 sm:p-6 rounded-2xl shadow-card border border-border/50">
                ...
                <div className="grid grid-cols-2 gap-4 text-xs sm:text-sm">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Véhicule : {formData.photos.vehicleAngles.length} photo(s)
                    </p>
                  </div>
                  <div>
                    <p className="text-muted-foreground">
                      Dommages proches : {formData.photos.damagePhotosClose.length} photo(s)
                    </p>
                    <p className="text-muted-foreground">
                      Dommages éloignées : {formData.photos.damagePhotosFar.length} photo(s)
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-card/80 backdrop-blur-sm rounded-3xl shadow-elegant border border-border/50 overflow-hidden">
          ...
          <div className="flex justify-between items-center p-3 sm:p-4 bg-muted/30 border-t border-border/50">
            <Button
              ...
              className="text-xs sm:text-sm px-3 py-2 min-w-0"
            >
